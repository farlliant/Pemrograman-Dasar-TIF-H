...
public class seleksi3 {
    ...
    public static void main(String[] args) {
        ...
        switch (pilihan) {
            ...
            case 1:
                System.out.println(
                    "Data diterima, jenis valuta Anda: Dolar Amerika Serikat"
                );
                ...
                System.out.println(
                    "Uang yang diterima: Rp " + (uang * 8000) + ",-"
                );
            ...
            case 2:
                System.out.println(
                    "Data diterima, jenis valuta Anda: Yen Jepang"
                );
                ...
                System.out.println(
                    "Uang yang diterima: Rp " + (uang * 4000) + ",-"
                );
            ...
            case 3:
                System.out.println(
                    "Data diterima, jenis valuta Anda: Poundsterling Inggris"
                );
                ...
                System.out.println(
                    "Uang yang diterima: Rp " + (uang * 10500) + ",-"
                );
            ...
            case 4:
                System.out.println(
                    "Data diterima, jenis valuta Anda: Euro MEE"
                );
                ...
                System.out.println(
                    "Uang yang diterima: Rp " + (uang * 8900) + ",-"
                );
            ...
            case 5:
                System.out.println(
                    "Data diterima, jenis valuta Anda: Riyal Arab Saudi"
                );
                ...
                System.out.println(
                    "Uang yang diterima: Rp " + (uang * 1100) + ",-"
                );
